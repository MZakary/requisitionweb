export const banqFormFields = [
  ...
  { key: 'noRequisitionBANQ', label: 'Numéro de réquisition', type: 'text', label2: 'Informations générales de la demande' },
  { key: 'noBonCommandeBANQ', label: 'Numéro bon de commande', type: 'text', defaultValue: 'GBQ' },
  { key: 'dateBonCommandeBANQ', label: 'Date du bon de commande', type: 'text' },
  ...
  { key: 'soustitreProjetBANQ', label: "Sous-Titre", type: 'text' }, // Titre et soustitre combine ensemble pour nom du projet quand cest banq (titre - soustitre)
...
export const banqFormFieldsAfterPhases = [
  ...
  { label: 'Facturation', type: 'header2' },
  {
    ...
    defaultValues: {
      ...
      3: { typeDeBraille: 'Duo-médias (- de 12 pages) = 50,00$', quantite: '', prix: '50.00', total: '0' },
      4: { typeDeBraille: 'Duo-médias (12 pages et +) = 100,00$', quantite: '', prix: '100.00', total: '0' },
