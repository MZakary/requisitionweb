...
export const banqFormFieldsAfterPhases = [
  ...
  { label: 'Facturation', type: 'header2' },
  {
    ...
    defaultValues: {
      ...
      4: { typeDeBraille: 'Duo-médias', nbrVol: '', quantite: '', prix: '1.95', total: '0' },
      5: { typeDeBraille: 'Trio-médias', nbrVol: '', quantite: '', prix: '1.95', total: '0' },
      6: { typeDeBraille: 'Ré-impression', nbrVol: '', quantite: '', prix: '0.35', total: '0' },
      7: { typeDeBraille: 'Couvertures', nbrVol: '', quantite: '', prix: '6.00', total: '0' },
      8: { typeDeBraille: 'Réparation cartable', nbrVol: '', quantite: '', prix: '15.00', total: '0' },
    },
    defaultRowCount: 9
  },
