export const formulaireFormFields = [
  ...
  { key:"courrielCheckboxFormulaire", label: 'Courriel', label2:"Finition et montage", type: 'checkbox' },
  ...
  { key: 'nomFichierSourceFormulaire', label: 'Nom/Description', label2:"Nom du fichier source ou description de la production", type: 'text' },
  
  { label: 'Formulaire - commentaire', type: 'header4' },
  { key: 'commentaireFormulaire', label: 'Commentaire', type: 'textarea' },
  
  { label: 'Formulaire - informations tech. multimédia', type: 'header4' },
  { key: 'nomTechMultiFormulaire', label: 'Nom', label2:"Informations tech. multimédia", type: 'text' },
  ...
  { key: 'checkboxCQTermineFormulaire', label: 'Terminé?', label2:"Contrôle de qualité", type: 'checkbox' },
